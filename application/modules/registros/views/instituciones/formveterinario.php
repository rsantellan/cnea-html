<form method="POST" action="<?php echo site_url("registros/saveVeterinario");?>" onsubmit="return saveBasicForm(this, 'form_errores_veterinarios', 'veterinario_', 'listado_veterinarios');">
...
<div id="form_errores_veterinarios">
