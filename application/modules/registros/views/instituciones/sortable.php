...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
        ...
        <script type="text/javascript" src="<?php echo base_url() . "assets/registros/js/sortable.js";?>"></script>
  ...
  <body>
    ...
    <input type="hidden" id="sort_ajax" value="<?php echo site_url("registros/applySortInstitucion");?>" />
  </body>
</html>
